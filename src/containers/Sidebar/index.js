...
export class Sidebar extends Component {
  ...
  render() {
    ...
    const {themeType, navCollapsed, width, navStyle, token} = this.props;
...
const mapStateToProps = ({settings,auth}) => {
  ...
  return {themeType, navStyle, navCollapsed, width, locale, token}
};
export default connect(mapStateToProps, {toggleCollapsedSideNav, updateWindowWidth, getUser})(Sidebar);
